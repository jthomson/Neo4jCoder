...
public class MatrixTest
{
    ...
    {
        MatrixTest matrix = new MatrixTest();
        matrix.setUp();
    ...
    public void setProperty(Node node, PropType propType, string value)
    {
        node.setProperty(propType.toString(), value);
    }
    ...
    public void createNodespace()
    {
        ...
        try
        {
            ...
            setProperty(thomas, PropTypes.NAME, "Thomas Anderson" );
